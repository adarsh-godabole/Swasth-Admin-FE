...
const CONTROL =
  'block w-full rounded-md bg-white px-2.5 py-2 text-sm text-slate-900 ring-1 ring-slate-300 ring-inset placeholder:text-slate-500 hover:ring-slate-400 focus:ring-2 focus:ring-indigo-600 disabled:bg-slate-50 disabled:text-slate-500 disabled:hover:ring-slate-300';
